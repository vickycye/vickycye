...
export const Projects = () => {
  ...
  return (
    <div id="personal-projects" className="bg-discord-gray py-24 sm:py-32">
      <div className="mx-auto max-w-2xl px-6 lg:max-w-7xl lg:px-8">
        <p 
          id="project-title" 
          ref={projectTitleRef} 
          className="mx-auto mt-2 max-w-5xl opacity-0 transition-opacity duration-1000 text-balance text-center text-4xl font-semibold tracking-tight text-light-orange-10 sm:text-5xl"
        >
        ...
        <div className="mt-10 grid gap-4 sm:mt-16 lg:grid-cols-3 lg:grid-rows-2">
          ...
          <div className="relative lg:row-span-2">
            <div className="absolute inset-px rounded-lg bg-cream lg:rounded-l-[2rem]"></div>
            <div className="relative flex h-full flex-col overflow-hidden rounded-[calc(theme(borderRadius.lg)+1px)] lg:rounded-l-[calc(2rem+1px)]">
              <div className="px-8 pb-2 pt-6 sm:px-10 sm:pb-0 sm:pt-10">
                ...
                <p className="mt-2 max-w-lg text-sm/6 text-gray-600 max-lg:text-center">
                  As an <span className="font-semibold text-dark-orange">Machine Learning Research Intern</span> in the University of Toronto's Department of Industrial and Mechanical Engineering, 
              ...
              <div className="absolute h-full w-full bg-discord-lighter-gray/95 flex items-center justify-center opacity-0 hover:opacity-100 transition-all duration-300">
                <Link href="#" className="text-white bg-discord-gray font-medium rounded-lg text-sm px-5 py-2.5 dark:bg-discord-lighter-gray">In Progress...</Link>
              </div>
            </div>
          ...
          <div className="relative max-lg:row-start-1">
            <div className="absolute inset-px rounded-lg bg-cream max-lg:rounded-t-[2rem]"></div>
            <div className="relative flex h-full flex-col overflow-hidden rounded-[calc(theme(borderRadius.lg)+1px)] max-lg:rounded-t-[calc(2rem+1px)]">
              <div className="px-8 pt-8 sm:px-10 sm:pt-10">
                <p className="mt-2 text-lg font-medium tracking-tight text-discord-gray max-lg:text-center">LeetCode Helper Extension</p>
                <p className="mt-2 max-w-lg text-sm/6 text-discord-lighter-gray max-lg:text-center">Chrome extension that provides personalised feedback and allows users to optimise their solutions or receive assistance from a model towards deriving their solution.</p>
              </div>
              ...
              <div className="absolute h-full w-full bg-discord-lighter-gray/95 flex items-center justify-center opacity-0 hover:opacity-100 transition-all duration-300">
                <a href="https://github.com/pickle-ai/pickle.ai.backend" className="text-white bg-discord-gray hover:bg-solid-orange-10 font-medium rounded-lg text-sm px-5 py-2.5 dark:bg-discord-lighter-gray dark:hover:bg-solid-orange-10">Repository</a>
                <div className="px-5"></div>
                <a href="https://devpost.com/software/pickle-ai" className="text-white bg-discord-gray hover:bg-solid-orange-10 font-medium rounded-lg text-sm px-5 py-2.5 dark:bg-discord-lighter-gray dark:hover:bg-solid-orange-10">Devpost</a>
              </div>
            </div>
          ...
          <div className="relative max-lg:row-start-3 lg:col-start-2 lg:row-start-2">
            <div className="absolute inset-px rounded-lg bg-cream"></div>
            <div className="relative flex h-full flex-col overflow-hidden rounded-[calc(theme(borderRadius.lg)+1px)]">
              ...
              <div className="absolute h-full w-full bg-discord-lighter-gray/95 flex items-center justify-center opacity-0 hover:opacity-100 transition-all duration-300">
                <a href="https://github.com/AQH-scale/AQH-scale.github.io" className="text-white bg-discord-gray hover:bg-solid-orange-10 font-medium rounded-lg text-sm px-5 py-2.5 dark:bg-discord-lighter-gray dark:hover:bg-solid-orange-10">Repository</a>
                <div className="px-5"></div>
                <a href="https://devpost.com/software/air-quality-health" className="text-white bg-discord-gray hover:bg-solid-orange-10 font-medium rounded-lg text-sm px-5 py-2.5 dark:bg-discord-lighter-gray dark:hover:bg-solid-orange-10">Devpost</a>
              </div>
            </div>
          ...
          <div className="relative lg:row-span-2">
            <div className="absolute inset-px rounded-lg bg-cream max-lg:rounded-b-[2rem] lg:rounded-r-[2rem]"></div>
